...
from wukong import Client, Worker, Nanny
from wukong.deploy.local import LocalCluster, nprocesses_nthreads
...
from wukong.utils import sync
from wukong.worker import TOTAL_MEMORY

from wukong.deploy.utils_test import ClusterTest
...
def test_local_tls(loop):
    from wukong.utils_test import tls_only_security
...
if sys.version_info >= (3, 5):
    from wukong.deploy.tests.py3_test_deploy import *  # noqa F401
