...
from wukong.diagnostics.eventstream import EventStream, eventstream
from wukong.metrics import time
from wukong.utils_test import div, gen_cluster
...
def test_eventstream(c, s, *workers):
    ...
    from wukong.diagnostics.progress_stream import task_stream_append
