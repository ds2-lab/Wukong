    ...
    **kwargs:
    ...
    def __init__(
        ...
        **kwargs
        ...
        from wukong.recreate_exceptions import ReplayExceptionClient
    ...
    def _release_key(self, key):
        """ Release key from wukong memory """
    ...
    def gather(self, futures, errors="raise", direct=None, asynchronous=None):
        """ Gather futures from wukong memory
    ...
    def _upload_environment(self, zipfile):
        ...
        def unzip(dask_worker=None):
            from wukong.utils import log_errors
            import zipfile
            import shutil
