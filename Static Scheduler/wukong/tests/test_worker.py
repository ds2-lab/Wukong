...
from wukong import Nanny, get_client, wait, default_client, get_worker, Reschedule
from wukong.compatibility import WINDOWS, cache_from_source
from wukong.core import rpc
from wukong.client import wait
from wukong.scheduler import Scheduler
from wukong.metrics import time
from wukong.worker import Worker, error_message, logger, parse_memory_limit
from wukong.utils import tmpfile, format_bytes
from wukong.utils_test import (
    inc,
    mul,
    gen_cluster,
    div,
...
def test_worker_ncores():
    from wukong.worker import _ncores
...
def test_access_key(c, s, a, b):
    def f(i):
        from wukong.worker import thread_state
...
def test_log_exception_on_failed_task(c, s, a, b):
    with tmpfile() as fn:
        ...
        try:
            from wukong.worker import logger
