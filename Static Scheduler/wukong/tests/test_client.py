...
from wukong.comm import CommClosedError
from wukong.client import (
    Client,
    Future,
    wait,
    as_completed,
...
from wukong.compatibility import PY3

from wukong.metrics import time
from wukong.scheduler import Scheduler, KilledWorker
from wukong.sizeof import sizeof
from wukong.utils import ignoring, mp_context, sync, tmp_text, tokey, tmpfile
...
def test_long_traceback(c, s, a, b):
    from wukong.protocol.pickle import dumps
...
if sys.version_info >= (3, 5):
    from wukong.tests.py3_test_client import *  # noqa F401
