...
from wukong import Nanny, Worker, Client, wait, fire_and_forget
from wukong.core import connect, rpc
...
from wukong.worker import dumps_function, dumps_task
...
from wukong.utils_test import loop, nodebug  # noqa: F401
...
def test_deque_handler():
    from wukong.scheduler import logger
